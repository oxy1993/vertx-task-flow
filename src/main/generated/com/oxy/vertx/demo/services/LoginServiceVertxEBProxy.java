...
public class LoginServiceVertxEBProxy implements LoginService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public LoginServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public LoginServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
